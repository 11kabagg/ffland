const CONFIG = {
  ...
  statistics: [
    { value: 14, label: "дней серверу", suffix: "" },
  ...
  team: [
    ...
    { initials: "CM", name: "---", role: "Контент-Мейкер", text: "Создает видео, делает наш проект популярным, поддерживает онлайн", tags: ["Контент", "Видео"] },
  ],
