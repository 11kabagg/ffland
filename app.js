const CONFIG = {
  ...
  news: [
    { date: "1.07.2026", title: "Помогите нам!", text: "Нам очень нужен ваш голос на этом сайте! Вы очень поможете нашему онлайну! https://minecraftrating.ru/server/ffland/" },
    { date: "30.06.2026", title: "Переезд", text: "Мы переехали на новый домен - ffland.space" },
    { date: "12.04.2026", title: "Мы открылись!", text: "Чтобы зайти, нужно подать заявку в нашем ВК FFLand." },
    { date: "10.04.2026", title: "Ищем контент-мейкеров", text: "Умеешь и хочешь снимать видео? Ты можешь помочь проекту, для подробностей напиши нам в личные сообщения ТГК!" },
  ...
  gallery: [
    ...
    { title: "Сборище игроков", caption: "", tag: "ЧеЛоВеКи", image: "./assets/screenshots/peoples.png" },
  ],
  historyIntro:
    "",
  historyStages: [
  ...
  team: [
    { initials: "KB", name: "kabagg", role: "Владелец/Разработчик", text: "Отвечает за концепцию проекта, сезон, техническую составляющую и общее направление сервера.", tags: ["Организация", "Развитие", "Комьюнити"] },
    { initials: "AD", name: "Jikop_Grisha, MaxiDom3000, vanko68", role: "Администраторы", text: "Следят за порядком, игровыми процессами, и игроками", tags: ["Порядок", "Поддержка"] },
    { initials: "CM", name: "MaxiDom3000", role: "Контент-Мейкер", text: "Создает видео, делает наш проект популярным, поддерживает онлайн.", tags: ["Контент", "Видео"] },
  ],
...
function renderStaticContent() {
  ...
  dom.footerText.textContent = "Мы открылись!";
}
