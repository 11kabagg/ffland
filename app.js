const CONFIG = {
  ...
  server: {
    ...
    heroLead:
      "",
    about:
      "Сервер задуман как место для спокойной, и атмосферной игры. Без кричащего донат-перегруза и без потери ванильного ощущения мира, к примеру у нас есть плагин на кастомные пластинки, который не убивает ваниллу, а только дополняет ее. На первый план здесь выходят комьюнити, взаимодействие и приятная ежедневная игра. ",
    statusApiUrl: "",
    statusFallback: {
      online: false,
      players: null,
